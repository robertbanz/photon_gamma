...
#define SYSTEMNAME "GAMMA  (beta test)"
#define SYSTEMDATE "02/05/92"

#define STORENUM "010"  /*3*/
#define SITENUM "1"     /*2*/
#define OPTNUM "02"     /*1*/
#define LICNUM "A001"   /*4*/
#define REVNUM "020592" /*6*/
#define LOCNAME "BALTIMORE"
...
/*#include "c:\tc\photon.h"
#include "c:\tc\phoproto.h"*/